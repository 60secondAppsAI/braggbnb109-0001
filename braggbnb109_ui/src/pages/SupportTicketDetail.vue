              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Issue Description</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Resolution Status</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ResolutionStatus" type="text" placeholder="Enter ResolutionStatus" v-model="supportTicketDetails.resolutionStatus"></input>
																		</div>
						</td>
														</tr>
